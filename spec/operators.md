...
**Note:** A trailing semicolon (`;`) is **also invalid** in Foundation Shell. Unlike some shells that allow trailing semicolons, Foundation Shell requires a command after each operator.
...
3. **Trailing semicolon**: Foundation Shell requires a command after `;`
