...
// Helper function for executing piped commands in a command chain
static Task<int> executeCommandsWithPipesAsync(const std::vector<Command> &commands)
{
	if (commands.empty())
	{
		co_return 0;
	...
	for (size_t i = 0; i < commands.size(); ++i)
	{
		...
		// TODO: This needs to be updated to use Source/Sink instead of file descriptors
		// We'll address that in a future task
