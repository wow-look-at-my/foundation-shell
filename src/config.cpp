...
namespace Constants {
    ...
    std::map<std::string, std::map<std::string, std::string>> predefinedThemes = {
        {
            "default", {
                {"directory", Colors::COLOR_BLUE},
                {"prompt", Colors::COLOR_RESET},
                {"success", Colors::COLOR_GREEN},
                {"error", Colors::COLOR_RED},
                {"command", Colors::COLOR_WHITE},
                {"header", Colors::COLOR_CYAN + Colors::COLOR_BOLD}
            }
        },
        {
            "dark", {
                {"directory", Colors::COLOR_CYAN},
                {"prompt", Colors::COLOR_YELLOW},
                {"success", Colors::COLOR_GREEN},
                {"error", Colors::COLOR_RED},
                {"command", Colors::COLOR_MAGENTA},
                {"header", Colors::COLOR_YELLOW + Colors::COLOR_BOLD}
            }
        },
        {
            "light", {
                {"directory", Colors::COLOR_BLUE},
                {"prompt", Colors::COLOR_MAGENTA},
                {"success", Colors::COLOR_GREEN},
                {"error", Colors::COLOR_RED},
                {"command", Colors::COLOR_BLUE},
                {"header", Colors::COLOR_BLUE + Colors::COLOR_BOLD}
            }
        },
        {
            "monochrome", {
                {"directory", Colors::COLOR_WHITE},
                {"prompt", Colors::COLOR_WHITE},
                {"success", Colors::COLOR_WHITE},
                {"error", Colors::COLOR_WHITE},
                {"command", Colors::COLOR_WHITE},
                {"header", Colors::COLOR_WHITE + Colors::COLOR_BOLD}
            }
        }
    };
}
